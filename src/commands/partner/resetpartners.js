...
module.exports = {
  ...
  async execute(interaction) {
    if (interaction.user.id !== interaction.guild.ownerId) {
      return interaction.reply({ embeds: [require('../../utils/embed').buildEmbed({ color: 'error', title: '❌ Owner Only', description: 'Only the server owner can reset the partner leaderboard.' })], ephemeral: true });
    }
