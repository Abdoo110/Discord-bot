...
module.exports = {
  ...
  async execute(interaction) {
    ...
    await StickyMessage.findOneAndUpdate({ guildId: interaction.guild.id, channelId: interaction.channel.id }, { messageId: msg.id, content }, { upsert: true, new: true });
    await interaction.reply({ embeds: [require('../../utils/embed').buildEmbed({ color: 'success', title: '✅ Message Stuck', description: 'The message has been pinned at the bottom of this channel.' })], ephemeral: true });
  },
};
