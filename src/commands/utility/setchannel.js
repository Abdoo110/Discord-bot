...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addStringOption(o => o.setName('type').setDescription('What channel to configure').setRequired(true)
      .addChoices(
        { name: 'Mod Logs', value: 'modLogs' }, { name: 'Message Logs', value: 'messageLogs' },
        { name: 'Warning Logs', value: 'warningLogs' }, { name: 'Vouch Logs', value: 'vouchLogs' },
        { name: 'Staff Logs', value: 'staffLogs' }, { name: 'Giveaway Logs', value: 'giveawayLogs' },
        { name: 'Bug Reports', value: 'bugReports' }, { name: 'Partner Channel', value: 'partnerChannel' },
      ))
  ...
  async execute(interaction) {
    ...
    const labels = { modLogs:'Mod Logs', messageLogs:'Message Logs', warningLogs:'Warning Logs', vouchLogs:'Vouch Logs', staffLogs:'Staff Logs', giveawayLogs:'Giveaway Logs', bugReports:'Bug Reports', partnerChannel:'Partner Channel' };
